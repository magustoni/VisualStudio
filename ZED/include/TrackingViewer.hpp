...
void render_3D(cv::Mat &left, sl::float3 img_scale, std::vector<sl::ObjectData>& objects, bool isTrackingON, sl::BODY_FORMAT body_format);

void render_complete(cv::Mat& left, sl::float2 img_scale, sl::float3 img_scale_3D, std::vector<sl::ObjectData>& objects, bool isTrackingON, sl::BODY_FORMAT body_format, std::chrono::system_clock::time_point inicio);
